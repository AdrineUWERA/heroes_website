    ...
    <body>
        <div class="container">
            <form action="php/add.php" method="post">
                ...
                <div class="mb-3">
                    <label for="email" class="form-label text-white">Real name:</label>
                    <input 
                        type="text" 
                        class="form-control" 
                        id="real_name"
                ...
                <div class="mb-3">
                    <label for="email" class="form-label text-white">Last seen:</label>
                    <input 
                        type="text" 
                        class="form-control" 
                        id="last_seen"
                ...
                <div class="mb-3">
                    <label for="name" class="form-label text-white">Short bio:</label>
                    <textarea 
                        type="text" 
                        class="form-control" 
                        id="short_bio" 
                ...
                <div class="mb-3">
                    <label for="email" class="form-label text-white">Long bio:</label>
                    <textarea 
                        type="text" 
                        class="form-control" 
                        id="long_bio"
                ...
                <!-- <a href="list_heroes.php" class='link-primary'>View</a> -->
            </form>
        </div>
